...
class Document(models.Model):
    ...
    diagnosis = models.CharField(max_length=1000, null=True, blank=True, db_index=True,  verbose_name=_('diagnosis'))
    institution = models.CharField(max_length=1000, null=True, blank=True, db_index=True,  verbose_name=_('medical institution'))
    ...
    age = models.CharField(max_length=50, null=True, blank=True, db_index=True,  verbose_name=_('age'))

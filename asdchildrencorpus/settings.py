...
ROOT_URLCONF = 'asdchildrencorpus.urls'

WSGI_APPLICATION = 'asdchildrencorpus.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'autism_corpus',                      # Or path to database file if using sqlite3.
...
STATIC_URL = '/asdchildrencorpus/static/'
...
LOCALE_PATHS = (
    '/home/elmira/asdchildrencorpus/locale',
)